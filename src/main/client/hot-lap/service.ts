...
import {removeProp} from "../track/service/objects/prop";
import {toggleFixtureRemoval} from "../track/service/objects/fixture-removal";
import {createCheckpoint, removeCheckpoint} from "../track/service/objects/checkpoint";
...
import {BLIP, DEFAULT_CHECKPOINT_HEIGHT, UPDATE_OBJECTS_DETECTION_RADIUS} from "./constants";
...
function updateCheckpoints(checkpoints: Checkpoint[]) {
  ...
  const followUp = checkpoints[followUpIndex];
